...
@section('child-content')
    ...
    <div style="display: flex; justify-content: center; align-items: center; min-height: 80vh;">
        <div
            style="background: #ffffff; padding: 40px; border-radius: 12px; box-shadow: 0 4px 15px rgba(0,0,0,0.05); width: 100%; max-width: 400px;">
            ...
            @if ($errors->any())
                <div
                    style="background-color: #fee2e2; color: #dc2626; padding: 12px; border-radius: 6px; margin-bottom: 20px; font-size: 14px; text-align: center;">
            ...
            <form method="POST" action="{{ route('login') }}">
                ...
                <div style="margin-bottom: 20px;">
                    <label style="display: block; margin-bottom: 8px; font-weight: bold; color: #444;">อีเมล หรือ
                        เบอร์โทรศัพท์</label>
                ...
                <div style="margin-bottom: 25px;">
                    <label style="display: block; margin-bottom: 8px; font-weight: bold; color: #444;">รหัสผ่าน
                        (Password)</label>
