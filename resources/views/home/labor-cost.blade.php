                ...
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="well text-center" style="background-color: #f0f7ff; border-color: #d1e9ff;">
                            <p class="text-primary" style="margin-bottom: 5px;"><strong>ปริมาณดินที่ต้องใช้ประมาณ</strong>
                            </p>
            ...
            <div class="col-md-8 col-md-offset-2">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="well well-sm">
                            <ul>
                                ...
                                <li><strong>ปริมาณดินที่ต้องใช้ = 1,600 x 1 = 1,600 ลูกบาศก์เมตร หรือ 1,600 คิว</strong>
                                </li>
                            </ul>
                        </div>
                        <p class="text-muted small">* หมายเหตุ: ขึ้นอยู่กับลักษณะดินเดิม, การบดอัด
                            และระดับความแน่นที่ต้องการ อาจเผื่อไว้ 5-10%</p>
                        ...
                        <div class="alert alert-warning">
                            <p><strong>ตาม พ.ร.บ. ควบคุมอาคาร พ.ศ. 2522:</strong> การถมที่ดินที่สูงเกิน 0.5 เมตร
                                ต้องยื่นขออนุญาตจากเขต หรือ อบต. โดยเฉพาะหากติดเขตเพื่อนบ้านหรือใกล้แหล่งน้ำสาธารณะ</p>
                        </div>

                        <h4><strong>4. เทคนิคถมดินสร้างบ้านไม่ให้ทรุด</strong></h4>
                        <ul class="list-group">
                            <li class="list-group-item"><i class="glyphicon glyphicon-ok"></i>
                                <strong>บดอัดเป็นชั้น:</strong> ทุก 30-50 ซม. แล้วบดอัดให้แน่น</li>
                            <li class="list-group-item"><i class="glyphicon glyphicon-ok"></i>
                                <strong>เลือกดินที่เหมาะสม:</strong> เช่น ดินลูกรัง หรือดินเหนียวผสมลูกรัง</li>
                            <li class="list-group-item"><i class="glyphicon glyphicon-ok"></i> <strong>พักหน้าดิน:</strong>
                                ไว้อย่างน้อย 3-6 เดือน</li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="panel-group" id="accordion">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">ทำได้ แต่ต้องมีระบบกันดินไหล เช่น กำแพงกันดิน และไม่ละเมิดสิทธิ์เพื่อนบ้าน
                        </div>
                    </div>
                </div>
                ...
                <div class="well text-center" style="background-color: #2c3e50; color: white; margin-top: 40px;">
                    ...
                    <div style="font-size: 1.2em; margin: 20px 0;">
                        ...
                        <p><i class="glyphicon glyphicon-user"></i> Line/FB: <strong>0627188847 / ธีรพงษ์เซอร์วิส</strong>
                        </p>
                    </div>
