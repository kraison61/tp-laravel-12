            ...
            <div class="row">
                <div class="col-md-9">
                    <div class="title-base text-left">
                        ...
                        <p>ยินดีต้อนรับสู่บริการงานวิศวกรรมฐานรากและรั้วรอบขอบชิด
                            เราคือผู้เชี่ยวชาญด้านการจัดการพื้นที่ต่างระดับและการล้อมรั้วมาตรฐานสูง
                            โดยเน้นความแข็งแรงทนทานในราคาที่ยุติธรรม</p>
                    </div>
                </div>
                <div class="col-md-3">
    ...
    <div class="section-empty section-item">
        <div class="content container">
            <div class="maso-list  list-sm-6">
                        ...
                        <div class="maso-item col-md-4 col-sm-6">
                            <div class="img-box adv-img adv-img-classic-box">
                                <a class="img-box" target="_blank" href="{{ route('service.show', $item->category->slug) }}">
                                    <img src="{{ Storage::disk('s3')->url($item->img) }}" alt="">
                                </a>
                                <div class="caption">
                ...
                <div class="list-nav">
                    <a href="#" class="btn btn-sm circle-button load-more-maso" data-pagination-anima="fade-bottom"
                        data-page-items="9">
                        Load More
